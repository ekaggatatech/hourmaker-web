...
10. PRICING FACTS: Hourmaker has exactly 3 plans — Basic (₹0/mo, up to 5 employees), Pro (₹65/mo or ₹58/mo billed annually, min 6 seats), Enterprise (₹90/mo or ₹80/mo billed annually, min 25 seats). There is no Free plan and no Pro Plus plan. Ignore older catalogs or blank "/mo" prices from search results.
