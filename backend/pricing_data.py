...
APP_VERSION = "2026-09-21-plans-v3"
...
PRICING_FACTS = (
    "Hourmaker has exactly 3 plans (per user/month). There is no Free plan and no Pro Plus plan. "
    "Never use older plan names or blank prices.\n"
    "- Basic: ₹0/mo — up to 5 employees (incl. admin)\n"
