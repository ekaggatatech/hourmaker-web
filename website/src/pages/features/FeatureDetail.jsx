...
const FeatureDetail = () => {
  ...
  // YouTube video embed URL (converted from share link)
  ...
  return (
    <Layout>
      ...
      <section className="bg-gradient-to-b from-white to-primary/5 py-16 lg:py-20 overflow-hidden">
        <div className="container max-w-6xl">
          ...
          <h1 className="sr-only">
            ...
            {!feature.id?.match(
              /automatic-tracking|manual-tracking|attendance|onboarding|projects|billing|invoicing|analytics|holiday|meeting-scheduling|client-management|user-management|access-management|docs-portal/,
            ...
            <div>
              ...
              <div className="grid grid-cols-3 gap-4 max-w-md">
                {feature.benefits.slice(0, 3).map((benefit, index) => (
                  <div
                    key={index}
                    className="text-center p-3 bg-white/80 backdrop-blur-sm rounded-xl"
                  >
                ...
                >
                  ...
                  <div className="lg:w-1/3">
                    <div className="relative">
                      ...
                      <div className="relative bg-gradient-to-br from-primary/5 to-primary-light/10 rounded-2xl p-8 text-center">
                        <div className="w-20 h-20 mx-auto bg-primary rounded-2xl flex items-center justify-center mb-4">
                          <span className="text-2xl font-bold text-white">
                            {String(index + 1).padStart(2, "0")}
                          </span>
                        </div>
                        <h3 className="font-poppins text-xl font-semibold text-primary-dark">
                          {detail.title}
                        </h3>
                      </div>
                    </div>
                  ...
                  <div className="lg:w-2/3">
                    <div className="space-y-4">
                      <h4 className="font-poppins text-2xl font-bold text-primary-dark">
                        {detail.title}
                      </h4>
            ...
            {relatedFeatures.map((related) => {
              ...
              return (
                <Link
                  ...
                  className="group bg-white rounded-xl p-6 shadow-sm hover:shadow-xl transition-all hover:-translate-y-1 border border-border/50"
                >
      ...
      {/* CTA */}
      <section className="cta-gradient py-16 text-white text-center">
