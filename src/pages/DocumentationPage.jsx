...
const features = [
  {
    ...
    details: [
      ...
      "Mobile app for on-the-go time entry",
    ...
    <Layout>
      ...
      {features.map((feature, index) => (
        <section
          key={feature.id}
          id={feature.id}
          className={`py-20 ${index % 2 === 0 ? "bg-white" : "bg-muted"}`}
        >
          <div className="container">
            <div className="flex flex-col lg:flex-row gap-12 items-start">
              <div className="lg:w-1/3">
                <div className="sticky top-48">
                  ...
                  <h2 className="font-poppins text-2xl md:text-3xl font-bold text-primary-dark mb-4">
                    {feature.title}
                  </h2>
