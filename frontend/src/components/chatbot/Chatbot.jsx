  ...
  const handleEscalationSubmit = async (e) => {
    ...
    try {
      ...
      if (firebaseResult.success) {
        ...
        setChatState("error");
        addBotMessage(
          "Sorry, there was an error sending your request. Please try again or email us at support@hourmaker.com",
        );
      }
    } catch (error) {
          ...
          <div className="space-y-1">
            ...
            <div>
              <input
                ...
                required
                className={`w-full px-3 py-2 text-xs border rounded-lg bg-background focus:outline-none focus:ring-2 ${escalationErrors.email
      ...
      <div className="p-4 border border-destructive/30 rounded-xl bg-destructive/10 mt-3">
        <div className="flex items-center gap-2">
          ...
          <p className="text-sm text-destructive">
            ...
            <a
              href="mailto:support@hourmaker.com"
  ...
  return (
    <>
      ...
      <button
        ...
        className={`fixed bottom-6 right-6 z-50 w-14 h-14 rounded-full shadow-lg transition-all duration-300 hover:scale-110 ${isOpen
              ...
              >
                ...
                >
                  ...
                  <div className="flex flex-col items-center gap-1 flex-shrink-0">
                    <div
                      className={`w-8 h-8 rounded-full flex items-center justify-center ${message.isUser ? "bg-muted" : "bg-primary/10"
                        }`}
                    >
                      {message.isUser ? (
                  ...
                  >
                    <div
                      className={`rounded-2xl px-4 py-3 text-sm ${message.isUser
